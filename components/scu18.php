<div class="content">
    <?php
        $text = (object) [
            'ENG' => (object) [
                'title' => 'Redeem your SCU18 Tokens',
                'explainer' => 'Connect your Metamask to redeem your SCU18 tokens for AAL at a 1 to 1 ratio.',
                'action' => 'Convert SCU',
                'time' => 'Convertibility will start in:'
            ],
            'ES' => (object) [
                'title' => 'Convierta sus tokens SCU18',
                'explainer' => 'Conecte su Metamask para convertir sus token SCU18 en AAL al 1 por 1.',
                'action' => 'Convertir SCU',
                'time' => 'Va a poder convertir dentro de:'
            ],
            'ITA' => (object) [
                'title' => 'Converti i tuoi SCU18 in AAL',
                'explainer' => 'Connetti Metamask per gli SCU18 in AAL al tasso di conversione di 1 ad 1.',
                'action' => 'Converti SCU',
